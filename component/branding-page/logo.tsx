...
export default function Logo(props: PropsType) {
  ...
  useEffect(() => {
    if (window.innerWidth < 640) setIsPc(false);
    else if (window.innerWidth < 1024) setIsTablet(true);
  }, []);
  ...
  return (
    <svg className={className}
      ...
      width={isPc ? (isTablet ? '150' : '197') : '129'}
      height="35" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
